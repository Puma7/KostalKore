    ...
    def diagnose_ac_grid(self) -> AreaDiagnosis:
        ...
        if freq is not None and abs(freq - 50.0) > 1.0:
            return AreaDiagnosis(
                ...
                f"Netzfrequenz: {freq:.2f} Hz (normal: 50.0 Hz). Mögliche Netzstörung.",
        ...
        if voltage_issues:
            ...
            if any(v > 260 or v < 195 for _, v in voltage_issues):
                return AreaDiagnosis(
                    "ac_grid", DiagStatus.WARNUNG,
                    "Netzspannung außerhalb des Normalbereichs",
                    f"Auffällige Spannungswerte: {phases}. Normbereich: 207-253V.",
