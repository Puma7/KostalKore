...
DEFAULT_FEED_IN_LIMIT_W: Final[float] = 12400.0
...
class GridFeedInLimiterSwitch(SwitchEntity):
    ...
    def __init__(
        ...
        self._feed_in_limit_w: float = DEFAULT_FEED_IN_LIMIT_W
    ...
    def set_feed_in_limit(self, watts: float) -> None:
        self._feed_in_limit_w = max(0, watts)
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        await self._write_charge_limit(20000.0)
    ...
    async def _control_loop(self) -> None:
        ...
        try:
            while self._is_on:
                ...
                new_limit = max(0.0, min(20000.0, new_limit))
